...
;(function () {
    ...
    HowlerGlobal.prototype = {
        ...
        init: function () {
            ...
            // Pool of unlockd HTML5 Audio objects.
        ...
        _setupCodecs: function () {
            ...
            var checkOpera =
                self._navigator &&
                self._navigator.userAgent.match(/OPR\/([0-6].)/g)
            var isOldOpera =
                ...
                if (sound && !sound._paused) {
                    ...
                    if (sound._node) {
                        if (self._webAudio) {
                            ...
                            if (
                                typeof sound._node.bufferSource.stop ===
                                'undefined'
                            ) {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                if (sound) {
                    ...
                    if (
                        ...
                        if (loop) {
                            sound._node.bufferSource.loopStart =
                                sound._start || 0
                ...
                if (typeof pan === 'number') {
                    ...
                    if (sound._node) {
                        ...
                        if (pannerType === 'spatial') {
                            if (
                                typeof sound._panner.positionX !== 'undefined'
                            ) {
